      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 p-3">
              <PenTool className="w-full h-full text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-white">Handwritten Digit Recognition</h1>
              <p className="text-gray-400">Neural Network Model (MNIST)</p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <div className="p-4 bg-white/5 rounded-xl border border-white/20">
                  <canvas
                    ...
                    className="border border-white/30 rounded-lg cursor-crosshair"
              ...
              <div className="flex gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={clearCanvas}
                  className="flex-1 py-3 rounded-xl bg-white/10 text-white font-medium hover:bg-white/20 transition-all border border-white/20"
                >
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  className="flex-1 py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transition-all"
                >
                  {isLoading ? (
                    <div className="flex items-center justify-center gap-2">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20"
          >
            <h2 className="text-2xl font-bold text-white mb-6">Recognition Results</h2>
            ...
            {prediction ? (
              ...
              >
                {/* Main Prediction */}
                <div className="p-6 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-400/30 text-center">
                  <h3 className="text-lg font-semibold text-white mb-2">Predicted Digit</h3>
              ...
              <div className="text-center text-gray-400 py-20">
                ...
                <p>Draw a digit on the canvas to see recognition results</p>
              </div>
            )}
          </motion.div>
        </div>
        ...
        >
          <h3 className="text-xl font-bold text-white mb-4">About MNIST Recognition</h3>
